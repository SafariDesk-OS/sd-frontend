...
const UpdateTaskStatus: React.FC<Props> = ({
    handleStatusUpdate,
    isSubmitting,
    selectedOption,
    setSelectedOption,
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full px-3 py-2 border  border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 resize-none"
                            />
                        </div>
                            ...
                            <div className="bg-green-50 border border-green-200 rounded-md p-3">
                                ...
                                <p className="text-green-700 mt-1">
                                    {selectedOption === 'completed' 
                                        ...
                                        : 'This will close the task and stop time tracking.'
                                    }
                                </p>
                            </div>
                        )}
